...
/** @defgroup FLASH_write_read_functions
  * @{
  */
#define TEST_FLASH_ADDRESS_START   (0x08000000 + 1024 * 63) /*63k的位置*/
...
error_status usr_flash_write(uint32_t write_addr,uint16_t *p_Buffer, uint16_t num_write);

typedef struct usr_cfg_datas{
    uint16_t out_voltage_cfg;
    uint16_t out_curr_limit_cfg;
    uint16_t h_vmax_set;
    uint16_t l_vmax_set;
}USR_VOL_CFG;
